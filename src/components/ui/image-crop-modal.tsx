...
export const ImageCropModal: React.FC<ImageCropModalProps> = ({
  ...
  const handleImageLoad = () => {
    ...
    // ✅ CRÍTICO: Aguardar um frame para garantir que o DOM está estável
    requestAnimationFrame(() => {
      if (!imageRef.current) return;

      console.log('🚀 Inicializando Cropper agora');
      
      // Configurações EXATAS do protótipo HTML que funciona
  ...
  const modalContent = (
    ...
    >
      <div className="h-full flex flex-col">
        ...
        <div className="bg-gray-900 px-4 py-3 flex items-center justify-between" style={{ flexShrink: 0 }}>
          <Button
            variant="ghost"
            size="sm"
            onClick={onClose}
          ...
          <Button
            ...
            className="text-purple-400 hover:bg-gray-800 font-bold disabled:opacity-50"
          >
            Aplicar
          </Button>
        </div>

        {/* ✅ ÁREA DE CROP - EXATAMENTE como no HTML que funciona */}
        ...
        {/* Controles - altura fixa */}
        <div className="bg-gray-900 px-4 py-4 space-y-3" style={{ flexShrink: 0 }}>
