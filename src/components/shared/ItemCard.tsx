...
import { Plus, MapPin, Search, Filter, Sparkles } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg shadow-sm border p-4 mb-6">
          ...
          {mostrarFiltrosAvancados && (
            <div className="space-y-6 border-t pt-4">
              ...
              {/* Faixa de Preço */}
              <div>
                <div className="flex items-center gap-2 font-medium mb-3 text-gray-700 uppercase text-sm tracking-wide">
                  <span>PREÇO: {precoRange[0]} - {precoRange[1]}</span>
